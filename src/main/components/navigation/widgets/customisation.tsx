...
const Customisation = ({
    ...
    return (
        <form
            ...
            className="md:p-4 md:w-96 top-12 right-0 z-40 rounded md:shadow-xl bg-zinc-300 dark:bg-zinc-900 w-auto"
        >
            ...
            <label className="mx-3 flex sm:items-center mt-2 justify-between flex-col sm:flex-row">
                ...
                <input
                    ...
                    className="px-2 sm:w-56 border rounded placeholder:px-2 text-sm sm:ml-2 dark:bg-slate-800 dark:text-white"
                />
            </label>
