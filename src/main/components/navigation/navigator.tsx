...
export const Navigator = ({ steamDetails, setSteamDetails }: NavigatorComponent) => {
    return (
            ...
            <div className="max-w-8xl mx-auto">
                <div className="py-4 border-b border-sky-900/10 px-8 md:border-0 dark:border-sky-300/10 mx-0">
                    <div className="z-40 flex justify-between items-center w-full">
                        <a className="mr-3 flex-none w-auto overflow-hidden md:w-auto" href="/">
                            <span className="text-slate-700 dark:text-white font-semibold dark:font-normal">Isaac Achievement Hunter</span>
                        </a>
                        <button
                            ...
                            onClick={() =>
                                openBrowser(
                                    `https://github.com/incendiarybean/isaac-achievement-hunter/releases/tag/v${process.env.REACT_APP_VERSION}`
                                )
                            }
                        >
                            <strong className="font-semibold">IAH V{process.env.REACT_APP_VERSION}</strong>
                        </button>
                        <DesktopNav
                            {...{
                                steamDetails,
