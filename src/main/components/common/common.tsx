...
export const CrossIcon = () => (
    <svg height="24" viewBox="0 0 21 21" width="24" xmlns="http://www.w3.org/2000/svg" className="">
...
export const TickIcon = () => (
    <svg height="24" viewBox="0 0 21 21" width="24" xmlns="http://www.w3.org/2000/svg" className="text-green-500">
        <g fill="none" fillRule="evenodd" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" transform="translate(2 2)">
...
export const LinkIcon = () => (
    <svg height="21" viewBox="0 0 21 21" width="21" xmlns="http://www.w3.org/2000/svg">
        <g fill="none" fillRule="evenodd" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" transform="translate(4 5)">
...
export const StatusChecker = ({ status, loading = false }: StatusCheckerComponent) => {
    switch (true) {
        case loading:
            return <Spinner />;
        case status:
